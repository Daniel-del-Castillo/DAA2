...
bin/ram_debug.o: headers/ram.hpp headers/ram_debug.hpp headers/instructions.hpp headers/memory_state.hpp src/ram_debug.cpp
	g++ -c -I . -o bin/ram_debug.o src/ram_debug.cpp 
	
bin/ram.o: headers/ram.hpp headers/instructions.hpp headers/memory_state.hpp src/ram.cpp
